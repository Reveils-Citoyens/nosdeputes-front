...
export const AdditionalInfoCard = async (props: {
  ...
  return (
    <Accordion elevation={0} disableGutters defaultExpanded sx={{ bgcolor: "grey.100", borderRadius: "16px" }}>
      <AccordionSummary
        aria-controls="additional-info-content"
        id="additional-info-header"
        sx={{ minHeight: 48, '& .MuiAccordionSummary-content': {my: 1}}}>
        <Typography variant="subtitle1" fontWeight={"bold"}>Informations complémentaires</Typography>
      </AccordionSummary>
