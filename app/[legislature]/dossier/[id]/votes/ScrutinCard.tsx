...
function getScrutinStatus(code: string | null) {
  if (code) {
    ...
    if (s === "adopté" || s === "adopte") return { status: "validated" as const, label: "Adopté" };
    if (s === "rejeté" || s === "rejete") return { status: "refused" as const, label: "Rejeté" };
  }
    ...
    >
      ...
      >
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 2 }}>
          <Box>
            <Typography variant="caption" color="text.secondary" fontWeight="bold" sx={{ textTransform: "uppercase", mb: 0.5, display: "block" }}>
        ...
        <Box sx={{ width: "100%", mt: 1 }}>
          ...
          <Box sx={{ display: "flex", height: 8, width: "100%", borderRadius: 4, overflow: "hidden", bgcolor: "grey.200" }}>
