...
export const HeroSection = ({
  ...
  return (
    <>
    {/* For now, the breadcrumbs are not necessary because of little hierarchy / just Dossiers > This Dossier. Can be added later. */}
      {/* <Breadcrumbs
      ...
      >
        ...
        <Box
          sx={{
            position: "absolute",
            top: 80, // navbar + breadcrumb height – Used to be 104
            left: 0,
            zIndex: -1,
